...
with st.container():
    ...
    with text_colum:
        st.subheader("Finding Fraudulent transactions using RandomForestClassifier")
        st.write("https://github.com/mlarjun/Data-Science-Internship---INSAID/tree/main")
        st.subheader("Finding Fake news using LogisticRegression model")
        st.write("https://github.com/mlarjun/ml/blob/main/project_1")
with st.container():
    st.write("---")
    st.write("##")
    st.header(" ")
